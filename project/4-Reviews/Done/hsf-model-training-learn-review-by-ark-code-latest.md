...
**Date:** 2026-06-22
**Artifact reviewed:** `docs/learning/hsf-model-training-tutorial.html` (12-slide offline HTML deck, 771 lines)
**Companion material consulted:** `docs/learning/hsf-model-training-tutorial.md` (markdown source), `docs/learning/hsf-model-training-reading-priority.md` (reading-priority spec), `AGENTS.md`
