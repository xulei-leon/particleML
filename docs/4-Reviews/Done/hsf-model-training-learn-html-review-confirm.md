...
- `docs/preparation/hsf-model-training-learn.html`
...
- `docs/preparation/hsf-model-training-priority.md`
- `AGENTS.md`
...
`docs/preparation/hsf-model-training-learn.html` should not be considered complete for the stated learning goal yet. It is a strong workflow deck, but it needs additional principle-focused slides and clearer visual explanations before it can function as a beginner-friendly neural-network tutorial for this project.
