...
The goal of this project is not a general survey of JetClass, but to use it as the **data foundation for a jet foundation model**, serving the core tasks in Research Plan v0.2 (archived in Git history):
